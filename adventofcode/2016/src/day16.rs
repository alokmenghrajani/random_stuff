...
//
// For the data to not be suspiscious, it needs to have certain properties; purely random data will
...
// character is a 1. If the characters do not match (01 or 10), the next checksum character is a 0.
// This should produce a new string which is exactly half as long as the original. If the length of
// the checksum is even, repeat the process until you end up with a checksum with an odd length.
//
...
// This puzzle wasn't very hard, you just have to be careful about not re-allocating/copying
