...
impl Md4 {
    pub fn new_without_padding() -> Md4 {
        let mut r = Md4::default();
        r.skip_padding = true;
        return r;
    }

    pub fn new_with_state(s: [u32; 4], l: u64) -> Md4 {
        assert!(l % 64 == 0);
        let mut r = Md4::default();
        r.state = Md4State { s: u32x4(s[0], s[1], s[2], s[3]) };
        r.length_bytes = l;
        return r;
    }
